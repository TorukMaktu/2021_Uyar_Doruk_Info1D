"""
    ...
    Nécessite un fichier DUMP en MySql de la BD : /database/2021_Uyar_Doruk_Info1D.sql
"""
import os
import re
...
class Toolsbd:
    ...
    def test_cmd_CRD_file_dump_sql():
        """
            ...
            Tester si il y a des problèmes éventuels sur le fichier : "2021_Uyar_Doruk_Info1D.sql"
        ...
        try:
            if os.path.exists(NAME_FILE_DUMP_SQL_BD):
                ...
                lignes_fichier_dump = fichier_dump_sql_bd.read()
                """
                    Si le fichier DUMP en SQL "../database/2021_Uyar_Doruk_Info1D.sql" existe, 
