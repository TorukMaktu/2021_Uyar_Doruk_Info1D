...
"""
    ...
    But : Montrer l'utilisation d'une liste déroulante (WTF) dont le contenu est basé sur la table "t_theme"
    
"""


class DemoFormSelectWTF(FlaskForm):
    theme_dropdown_wtf = SelectField('Thème (liste déroulante)',
                                      validators=[DataRequired(message="Sélectionner un theme.")],
    ...
    #                                   coerce=int
    #                                   )
    submit_btn_ok_dplist_genre = SubmitField("Choix theme")
