...
def demo_select_wtf():
    ...
    # Objet formulaire pour montrer une liste déroulante basé sur la table "t_theme"
    ...
    try:
        if request.method == "POST" and form_demo.submit_btn_ok_dplist_genre.data:
            ...
            if form_demo.submit_btn_ok_dplist_genre.data:
                print("Thème sélectionné : ",
                      form_demo.theme_dropdown_wtf.data)
                genre_selectionne = form_demo.theme_dropdown_wtf.data
                form_demo.theme_dropdown_wtf.choices = session['genre_val_list_dropdown']
        ...
        if request.method == "GET":
            ...
            for i in data_genres:
                genre_val_list_dropdown.append(i['nom_theme'])

            # Aussi possible d'avoir un id numérique et un texte en correspondance
            # genre_val_list_dropdown = [(i["id_theme"], i["nom_theme"]) for i in data_genres]

            print("genre_val_list_dropdown ", genre_val_list_dropdown)

            form_demo.theme_dropdown_wtf.choices = genre_val_list_dropdown
            ...
            form_demo.theme_dropdown_wtf.data = "philosophique"
            genre_selectionne = form_demo.theme_dropdown_wtf.data
            print("theme choisi dans la liste :", genre_selectionne)
